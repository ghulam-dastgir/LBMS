...
<body>
    ...
    <div id="wrapper" class="container mt-5">
        <h1 class="text-primary mb-4">All Books</h1>
        <?php
        $sql="SELECT * FROM books JOIN authors ON books.book_author = authors.author_id ORDER BY book_id ASC";
        ...
        <table class="table">
               ...
               <tbody>
                   ...
                   <tr>
                       <th scope="col"><?php echo $row['book_id']; ?></th>
                       <td><?php echo $row['book_name']; ?></td>
                       <td><?php echo $row['author_name']; ?></td>
                       <td><?php echo $row['b_category']; ?></td>
                       <td><?php echo $row['book_no']; ?></td>
                       <td><?php echo $row['book_price']; ?></td>
                       <td><a href="delete_b.php" class="btn btn-danger btn-sm mr-2">DELETE</a> <a href="update_b.php" class="btn btn-warning btn-sm">UPDATE</a></td>
                   </tr>
                   <?php  } ?>
               </tbody>
        </table>
